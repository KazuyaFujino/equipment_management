...
class RentalsTest < ApplicationSystemTestCase
  ...
  test "creating a Rental" do
    ...
    fill_in "Checkin date", with: @rental.checkin_date
    fill_in "Checkin due date", with: @rental.checkin_due_date
    fill_in "Checkout date", with: @rental.checkout_date
    fill_in "Items", with: @rental.items_id
